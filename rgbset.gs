...
*
* radar reflectivity colors from 5 to 70 DbZ
'set rgb 81 102 255 255'
'set rgb 82  51 153 255'
'set rgb 83   0   0 255'
'set rgb 84   0 255   0'
'set rgb 85   0 204   0'
'set rgb 86   0 153   0'
'set rgb 87 255 255   0'
'set rgb 88 255 204   0'
'set rgb 89 255 102   0'
'set rgb 90 255   0   0'
'set rgb 91 204  51   0'
'set rgb 92 153   0   0'
'set rgb 93 255   0 255'
'set rgb 94 153  51 204'
'set rgb 95 245 245 245'

*white
'set rgb 128 255 255 255'
*yellow
'set rgb 129 255 255 0'
*Red
'set rgb 130 100   0   0'
