...
getseries(cape255_0mb,cape255_0mb,1000)
getseries(cin255_0mb,cin255_0mb,1000)
...
'define absmlcape=cape255_0mb-cin255_0mb'
'set grads off'
'set gxout contour'
'set vrange -25 1000'
*'set yaxis -250 2500 1000'
...
ymid=ylo + (yhi-ylo)/2
'set string  5 c 4 90'
'draw string 0.15 'ymid' Celkove pokrytie'
'set string  5 c 4 90'
'draw string 0.35 'ymid' oblacnostou'
'set string  1 c 4 90'
...
yhi=subwrd(panel.p,4)
ymid=ylo + (yhi-ylo)/2
'set string 8 c 4 90' ; 'draw string 0.15 'ymid' Priemerny'
...
yhi=subwrd(panel.p,4)
ymid=ylo + (yhi-ylo)/2
'set string 11 c 4 90' ; 'draw string 0.15 'ymid' Tlak vzduchu'
'set string 11 c 4 90' ; 'draw string 0.35 'ymid' (hlad.mora)'
...
yhi=subwrd(panel.p,4)
ymid=ylo + (yhi-ylo)/2
'set string 26 c 4 90' ; 'draw string 0.15 'ymid' 10m Rychlost'
'set string 26 c 4 90' ; 'draw string 0.35 'ymid' Vetra'
...
yhi=subwrd(panel.p,4)
ymid=ylo + (yhi-ylo)/2
'set string  2 c 4 90' ; 'draw string 0.15 'ymid' 2m Teplota '
...
yhi=subwrd(panel.p,4)
ymid=ylo + (yhi-ylo)/2
'set string 26 c 4 90' ; 'draw string 0.35 'ymid' 2m Rel. Vlhkost'
...
if (units='e')
  ...
  'set string 11 c 4 90' ; 'draw string .35 'ymid' 3h. Zrazky'
  'set string 1 c 4 90' ; 'draw string .65 'ymid' (mm)'
endif

'set string 1 l 4 0' ; 'draw string 0.4 0.7 Zrazky'
'set string 42 l 4 0' ; 'draw string 1.4 0.7 Celk./Dazd'
'set line 42 1 6'
'draw recf 1.25 0.65 1.35 0.75'
'set string  2 l 4 0' ; 'draw string 1.4 0.5 Konvektivne'
'set line 2 1 6'
'draw recf 1.25 0.45 1.35 0.55'
'set string 45 l 4 0' ; 'draw string 0.4 0.5 Mrzn. Dazd'
'set line 45 1 6'
'draw recf 0.25 0.45 0.35 0.55'
'set string 44 l 4 0' ; 'draw string 1.4 0.3 Sneh'
'set line 44 1 6'
'draw recf 1.25 0.25 1.35 0.35'
'set string 46 l 4 0' ; 'draw string 0.4 0.3 Lad.Zrna'
'set line 46 1 6'
...
'set string 1 r 6 0'
'set strsiz 0.16 .18'
label='Meteogram na 7-dni pre: 'name
...
'set strsiz 0.1 .12'
'set string 1 r 3 0' ; 'draw string 8.2 0.2 Graf (c) AMS EmsiWx Bytca, www.pocasie-bytca.sk'

'set strsiz 0.14 .16'
'set string 1 r 3 0' ; 'draw string 8.2 0.5 Data: NOAA GFS model, beh: 'huh
