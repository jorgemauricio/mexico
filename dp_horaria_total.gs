...
while(count<127)
  ...
  'set lon -119 -85'
  'set lat 9 33'
  'DEWPOINT=(tmp2m-273.15)-((100-rh2m)/5)'
  'd DEWPOINT'
  'set gxout shp'
  ...
  'draw title Temperatura de punto de rocio (%)\ valido para 'fecha
  'set string 1 c 1 0'
  'draw string 5.0 5.0 @INIFAP 2018'
  'printim dewpoint_'count'.png x1024 y1024 white'
  'set gxout print'
  'fprintf DEWPOINT dewpoint'count'.txt %g 253 1'
  'clear'
  'reset'
  count=count+1
endwhile
